  ...
  return (
    <div className="glass-card p-6">
      ...
      >
        ...
        <div className="flex gap-3 rounded-xl border border-surface-border bg-surface-card p-4">
          <input
            id="consent-txn"
            name="consent"
            type="checkbox"
          ...
          <label htmlFor="consent-txn" className="text-sm text-surface-muted">
            ...
            a condition of purchase. Carriers are not liable for delayed or undelivered
            messages. See our{" "}
            <a
              href="/sms-terms"
              target="_blank"
